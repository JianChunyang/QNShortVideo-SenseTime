package com.qiniu.pili.droid.shortvideo.demo.sensetime.utils;
    ...
    */
    public static boolean checkLicense(Context context) {
        ...
        if (activateCode == null|| (STMobileAuthentificationNative.checkActiveCodeFromBuffer(context, licenseBuffer, licenseBuffer.length(), activateCode, activateCode.length()) != 0)) {
            Log.d(TAG, "activeCode: " + (activateCode == null));
            if(mIsOnlineLinsense){
            ...
            Log.i(TAG, "generate license error: " + error);
            return false;
        }

        Log.i(TAG, "activeCode: " + activateCode);
    ...
    public static boolean checkLicense(Context context, byte[] licBuffer){
        ...
        if (activateCode == null|| (STMobileAuthentificationNative.checkActiveCodeFromBuffer(context, licenseBuffer, licenseBuffer.length(), activateCode, activateCode.length()) != 0)) {
            ...
            Log.d(TAG, "generate license error: " + error);
            return false;
        }
